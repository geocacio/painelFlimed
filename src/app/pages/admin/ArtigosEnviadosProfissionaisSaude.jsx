...
export class ArtigosEnviadosProfissionaisSaude extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <CssBaseline />
                <Portlet>
                    <PortletHeader title="Artigos Enviados por Profissionais de Saúde"
                    toolbar={(
...
export default ArtigosEnviadosProfissionaisSaude
