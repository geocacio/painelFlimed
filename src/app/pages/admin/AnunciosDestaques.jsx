...
export class AnunciosDestaques extends Component {
                    ...
                    toolbar={(
                        <PortletHeaderToolbar>
                            ...
                            <Select value={0} name="filter">
                                ...
                                <MenuItem value={1}>Empresas Aprovadas</MenuItem>
                                <MenuItem value={2}>Empresas Pendentes</MenuItem>
                                <MenuItem value={3}>Empresas Bloqueadas</MenuItem>
                                <MenuItem value={4}>Empresas Canceladas</MenuItem>
                                <MenuItem value={5}>Empresas que não Finalizaram o Destaque</MenuItem>
                                <MenuItem value={6}>Telefone das Empresas</MenuItem>
                            </Select>
                        </PortletHeaderToolbar>)}/>
                    <PortletBody>
