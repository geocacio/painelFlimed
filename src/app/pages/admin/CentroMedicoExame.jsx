...
export class CentroMedicoExame extends Component {
    ...
    state = {
        tableData: {
            ...
            rows: [
                ...
                nome_exame: 'Lorem Ipsum',
                exames_imagens: 'Lorem Ipsum',
                nome_laboratorio: 'Lorem Ipsum',
                data_exame: 'Lorem Ipsum',
                quantidade: 'Lorem Ipsum',
                lista_exames: 'Lorem Ipsum',
    ...
    render() {
        return (
            <React.Fragment>
                <CssBaseline />
                <Portlet>
                    <PortletHeader title="Centro Médico Exame"
                    toolbar={(
                        <PortletHeaderToolbar>
                            ...
                            <Select value={0} name="filter">
                                ...
                                <MenuItem value={3}>Pacientes que Faltaram ao Exames</MenuItem>
                                <MenuItem value={4}>Pacientes que Cancelaram os Exames</MenuItem>
...
export default CentroMedicoExame
